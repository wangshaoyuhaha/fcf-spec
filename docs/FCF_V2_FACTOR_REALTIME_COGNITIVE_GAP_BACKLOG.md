...
| V2-R33 | Local Holiday Liquidity State Foundation | IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_HOLIDAY_LIQUIDITY_EVIDENCE_ONLY |

Next product implementation phase: V2-R33 / APPROVED.

No successor phase after V2-R33 starts automatically.
