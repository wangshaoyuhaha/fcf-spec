...
| V2-R37 | Local Factor Validation Evidence Foundation | IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_FACTOR_VALIDATION_EVIDENCE_ONLY |

Next product implementation phase: V2-R37 / APPROVED.

No successor phase after V2-R37 starts automatically.
