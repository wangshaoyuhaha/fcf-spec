...
def test_current_state_manifest_records_exact_latest_fcp_delivery_state():
    ...
    assert truth in {
        "approval": FCP_0046_APPROVAL_STATE,
        "delivery": FCP_0046_DELIVERY_STATE,
        "validated": FCP_0046_VALIDATED_STATE,
        "final": FCP_0046_FINAL_STATE,
    }.values()
    assert manifest["roadmap"] == FCP_0046_FINAL_ROADMAP
