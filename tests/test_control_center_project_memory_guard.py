...
def test_current_state_manifest_records_exact_latest_fcp_delivery_state():
    ...
    assert truth in {
        "approval": FCP_0061_APPROVAL_STATE,
        "delivery": FCP_0061_DELIVERY_STATE,
        "validated": FCP_0061_VALIDATED_STATE,
        "final": FCP_0061_FINAL_STATE,
    }.values()
    assert manifest["roadmap"] == FCP_0061_FINAL_ROADMAP
