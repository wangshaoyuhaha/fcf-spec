...
def test_current_state_manifest_records_exact_latest_fcp_delivery_state():
    ...
    assert truth in {
        "approval": FCP_0053_APPROVAL_STATE,
        "delivery": FCP_0053_DELIVERY_STATE,
        "validated": FCP_0053_VALIDATED_STATE,
        "final": FCP_0053_FINAL_STATE,
    }.values()
    assert manifest["roadmap"] == FCP_0053_FINAL_ROADMAP
