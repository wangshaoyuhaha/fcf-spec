...
def test_current_state_manifest_records_exact_latest_fcp_delivery_state():
    ...
    assert truth in {
        "approval": FCP_0026_APPROVAL_STATE,
        "delivery": FCP_0026_DELIVERY_STATE,
        "validated": FCP_0026_VALIDATED_STATE,
        "final": FCP_0026_FINAL_STATE,
    }.values()
    assert manifest["roadmap"] == FCP_0026_FINAL_ROADMAP
