...
class V2R38LocalOperatorFactorGovernanceProjectionBoundary:
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            ...
            self.projection_mutation_allowed,
        ...
        if not all(required):
            raise ValueError("V2-R38 required authority boundary is disabled")
        if any(prohibited):
            raise ValueError("V2-R38 prohibited capability is enabled")
