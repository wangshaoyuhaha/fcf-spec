...
class V2R13MomentumIndicatorBoundary:
    ...
    def __post_init__(self) -> None:
        if not all(
            ...
            raise ValueError("mandatory momentum indicator boundary is open")
        if any(
            (
...
V2_R13_MOMENTUM_INDICATOR_BOUNDARY = V2R13MomentumIndicatorBoundary()
