...
class V2R19PercentageOscillatorBoundary:
    ...
    def __post_init__(self) -> None:
        if not all(
            ...
            raise ValueError("mandatory percentage oscillator boundary is open")
        if any(
            (
...
V2_R19_PERCENTAGE_OSCILLATOR_BOUNDARY = V2R19PercentageOscillatorBoundary()
