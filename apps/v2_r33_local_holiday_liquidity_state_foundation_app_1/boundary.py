...
class V2R33LocalHolidayLiquidityStateBoundary:
    ...
    fixed_last_three_days_rule_allowed: bool = False
    fixed_threshold_allowed: bool = False
    stress_direction_allowed: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            ...
            self.fixed_last_three_days_rule_allowed,
            self.fixed_threshold_allowed,
            self.stress_direction_allowed,
        ...
        if not all(required):
            raise ValueError("V2-R33 required authority boundary is disabled")
        if any(prohibited):
            raise ValueError("V2-R33 prohibited capability is enabled")
