...
from apps.research_workflow_app_1.contract import APP_ID, UPSTREAM_READ_SOURCES, validate_research_workflow_contract


STAGE_ID = "RESEARCH-WORKFLOW-D2"
...
def inspect_research_workflow_source(root_path: str, app_id: str, source_kind: str, relative_path: str) -> Dict[str, Any]:
    root = Path(root_path)
...
def build_research_workflow_source_manifest(
    root_path: Optional[str] = None,
    candidates: Optional[Iterable[Dict[str, str]]] = None,
) -> Dict[str, Any]:
    contract_result = validate_research_workflow_contract()
    ...
    source_records = [
        inspect_research_workflow_source(
            root_path=root,
            app_id=item["app_id"],
...
def validate_research_workflow_source_manifest(manifest: Dict[str, Any]) -> Dict[str, Any]:
