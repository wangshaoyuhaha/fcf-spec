...
from apps.decision_audit_app_1.contract import APP_ID, UPSTREAM_READ_SOURCES, validate_decision_audit_contract


STAGE_ID = "DECISION-AUDIT-D2"
...
def inspect_decision_audit_source(root_path: str, app_id: str, source_kind: str, relative_path: str) -> Dict[str, Any]:
    root = Path(root_path)
...
def build_decision_audit_source_manifest(
    root_path: Optional[str] = None,
    candidates: Optional[Iterable[Dict[str, str]]] = None,
) -> Dict[str, Any]:
    contract_result = validate_decision_audit_contract()
...
def validate_decision_audit_source_manifest(manifest: Dict[str, Any]) -> Dict[str, Any]:
