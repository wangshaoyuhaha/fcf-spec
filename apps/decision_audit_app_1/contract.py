"""DECISION-AUDIT-APP-1 boundary contract."""
...
APP_ID = "DECISION-AUDIT-APP-1"
STAGE_ID = "DECISION-AUDIT-D1"
...
MAY_GENERATE: List[str] = [
    ...
    "decision_audit_source_manifest",
    "decision_audit_event_schema",
    "decision_audit_review_model",
    "decision_audit_packet",
    "decision_audit_final_handoff",
]
...
CONTRACT: Dict[str, Any] = {
    ...
    "purpose": "paper-only local decision audit trail boundary",
...
def get_decision_audit_contract() -> Dict[str, Any]:
    return deepcopy(CONTRACT)


def validate_decision_audit_contract(contract: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
