...
class V2R10LocalTurnoverBoundary:
    ...
    def __post_init__(self) -> None:
        ...
        if not all(value is True for value in required):
            raise ValueError("V2-R10 required authority boundary is disabled")
        if any(value is not False for value in prohibited):
            raise ValueError("V2-R10 prohibited capability is enabled")


V2_R10_LOCAL_TURNOVER_BOUNDARY = V2R10LocalTurnoverBoundary()
