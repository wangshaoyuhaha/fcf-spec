...
class V2R25LocalCausalTransmissionGraphBoundary:
    ...
    causal_proof_claim_allowed: bool = False
    automatic_edge_selection_allowed: bool = False
    edge_deletion_allowed: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            ...
            self.causal_proof_claim_allowed,
            self.automatic_edge_selection_allowed,
            self.edge_deletion_allowed,
        ...
        if not all(value is True for value in required):
            raise ValueError("V2-R25 required authority boundary is disabled")
        if any(value is not False for value in prohibited):
            raise ValueError("V2-R25 prohibited capability is enabled")
