...
from apps.portfolio_review_app_1.contract import APP_ID, UPSTREAM_READ_SOURCES, validate_portfolio_review_contract


STAGE_ID = "PORTFOLIO-REVIEW-D2"
...
def inspect_portfolio_review_source(
    root_path: str,
    app_id: str,
    source_kind: str,
    relative_path: str,
...
def build_portfolio_review_source_manifest(
    root_path: Optional[str] = None,
    candidates: Optional[Iterable[Dict[str, str]]] = None,
) -> Dict[str, Any]:
    contract_result = validate_portfolio_review_contract()
    ...
    source_records = [
        inspect_portfolio_review_source(
            root_path=root,
            app_id=item["app_id"],
...
def validate_portfolio_review_source_manifest(manifest: Dict[str, Any]) -> Dict[str, Any]:
