"""PORTFOLIO-REVIEW-D6 final handoff."""
...
from apps.portfolio_review_app_1.review_packet import validate_portfolio_review_packet


STAGE_ID = "PORTFOLIO-REVIEW-D6"
...
def build_portfolio_review_final_handoff(
    packet: Dict[str, Any],
    handoff_id: str,
    generated_at_utc: Optional[str] = None,
) -> Dict[str, Any]:
    packet_validation = validate_portfolio_review_packet(packet)
...
def validate_portfolio_review_final_handoff(handoff: Dict[str, Any]) -> Dict[str, Any]:
