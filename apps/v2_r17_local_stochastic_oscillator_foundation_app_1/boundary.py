...
class V2R17StochasticIndicatorBoundary:
    ...
    def __post_init__(self) -> None:
        if not all(
            ...
            raise ValueError("mandatory stochastic indicator boundary is open")
        if any(
            (
...
V2_R17_STOCHASTIC_INDICATOR_BOUNDARY = V2R17StochasticIndicatorBoundary()
