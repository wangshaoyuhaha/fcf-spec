...
class V2R27LocalEventReactionQualityBoundary:
    ...
    ai_generated_label_allowed: bool = False
    participant_intent_inference_allowed: bool = False
    immature_outcome_promotion_allowed: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            ...
            self.ai_generated_label_allowed,
            self.participant_intent_inference_allowed,
            self.immature_outcome_promotion_allowed,
        ...
        if not all(value is True for value in required):
            raise ValueError("V2-R27 required authority boundary is disabled")
        if any(value is not False for value in prohibited):
            raise ValueError("V2-R27 prohibited capability is enabled")
