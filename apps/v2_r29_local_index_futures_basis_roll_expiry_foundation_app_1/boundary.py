...
class V2R29LocalIndexFuturesBasisRollExpiryBoundary:
    ...
    fixed_third_friday_override_allowed: bool = False
    bottom_claim_allowed: bool = False
    participant_intent_claim_allowed: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            ...
            self.fixed_third_friday_override_allowed,
            self.bottom_claim_allowed,
            self.participant_intent_claim_allowed,
        ...
        if not all(value is True for value in required):
            raise ValueError("V2-R29 required authority boundary is disabled")
        if any(value is not False for value in prohibited):
            raise ValueError("V2-R29 prohibited capability is enabled")
