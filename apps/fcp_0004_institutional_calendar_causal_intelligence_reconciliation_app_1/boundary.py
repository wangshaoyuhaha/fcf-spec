...
class InstitutionalArchitectureReconciliationBoundary:
    ...
    duplicate_module_creation_allowed: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        prohibited = (
            self.duplicate_module_creation_allowed,
        ...
        if not all(required) or any(prohibited):
            raise ValueError("architecture reconciliation boundary must remain fail-closed")


FCP_0004_BOUNDARY = InstitutionalArchitectureReconciliationBoundary()
