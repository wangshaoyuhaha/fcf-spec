...
class V2R14TrendIndicatorBoundary:
    ...
    def __post_init__(self) -> None:
        if not all(
            ...
            raise ValueError("mandatory trend indicator boundary is open")
        if any(
            (
...
V2_R14_TREND_INDICATOR_BOUNDARY = V2R14TrendIndicatorBoundary()
