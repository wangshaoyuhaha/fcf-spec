...
class V2R15VolatilityIndicatorBoundary:
    ...
    def __post_init__(self) -> None:
        if not all(
            ...
            raise ValueError("mandatory volatility indicator boundary is open")
        if any(
            (
...
V2_R15_VOLATILITY_INDICATOR_BOUNDARY = V2R15VolatilityIndicatorBoundary()
