...
COMMANDS = [
    ...
    [
        "python",
        "scripts/control_center_fcp_0070_btc_perpetual_paper_stress_deterministic_trigger_evaluation_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0071_btc_perpetual_paper_stress_trigger_result_review_registry_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0072_btc_perpetual_paper_stress_trigger_result_operator_review_packet_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0073_btc_perpetual_paper_stress_trigger_result_operator_review_receipt_guard.py",
    ],
    [
        "python",
    ...
    [
        "python",
        "scripts/control_center_fcp_0076_a_share_candidate_daily_promotion_readiness_gate_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0077_a_share_trusted_data_supply_chain_coverage_evidence_matrix_guard.py",
    ],
    [
        "python",
    ...
    [
        "python",
        "scripts/control_center_fcp_0092_a_share_guojin_qmt_local_cache_probe_operator_review_packet_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0093_btc_coin_metrics_reference_rate_local_csv_validation_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0094_btc_coin_metrics_reference_rate_operator_review_packet_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0095_a_share_qmt_local_export_continuity_routing_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0096_registered_factor_registry_runtime_guard.py",
    ],
    [
        "python",
    ...
    [
        "python",
        "scripts/control_center_fcp_0105_registered_price_shape_indicator_runtime_guard.py",
    ],
    [
        "python",
        "scripts/control_center_fcp_0106_a_share_qmt_internal_read_only_market_bridge_guard.py",
    ],
