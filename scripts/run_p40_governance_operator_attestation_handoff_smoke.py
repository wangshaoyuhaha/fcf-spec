...
if __name__ == "__main__":
 result = {"handoff": build_p40_governance_operator_attestation_handoff(), "packet": build_p40_operator_attestation_packet(), "gate": build_p40_operator_attestation_next_gate()}
