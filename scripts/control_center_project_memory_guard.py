...
V2_R21_APPROVAL_START = "<!-- V2-R21 LOCAL ROBUST NORMALIZATION FOUNDATION APP 1 APPROVAL START -->"
V2_R21_APPROVAL_END = "<!-- V2-R21 LOCAL ROBUST NORMALIZATION FOUNDATION APP 1 APPROVAL END -->"
V2_R21_LOCK_START = "<!-- V2-R21 LOCAL ROBUST NORMALIZATION FOUNDATION APP 1 LOCK START -->"
...
GAP_ROADMAP_R17_APPROVAL_LINES = (
    "| V2-R17 | Local Stochastic Oscillator Foundation | "
    "APPROVED / NOT_STARTED / REGISTERED_LOCAL_STOCHASTIC_CALCULATION_ONLY |",
...
GAP_ROADMAP_R17_DELIVERY_LINES = (
    "| V2-R17 | Local Stochastic Oscillator Foundation | "
    "IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_STOCHASTIC_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R17 / APPROVED.",
    "No successor phase after V2-R17 starts automatically.",
)
GAP_ROADMAP_R17_FINAL_LINES = (
    "| V2-R17 | Local Stochastic Oscillator Foundation | "
    "COMPLETED / REGISTERED_LOCAL_STOCHASTIC_CALCULATION_ONLY |",
    "Next product implementation phase: NOT_SELECTED / NOT_APPROVED.",
    "No successor phase starts automatically.",
)
GAP_ROADMAP_R18_APPROVAL_LINES = (
    "| V2-R18 | Local Directional Trend Strength Foundation | "
    "APPROVED / NOT_STARTED / REGISTERED_LOCAL_DIRECTIONAL_STRENGTH_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R18 / APPROVED.",
    "No successor phase after V2-R18 starts automatically.",
)
GAP_ROADMAP_R18_DELIVERY_LINES = (
    "| V2-R18 | Local Directional Trend Strength Foundation | "
    "IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_DIRECTIONAL_STRENGTH_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R18 / APPROVED.",
    "No successor phase after V2-R18 starts automatically.",
)
GAP_ROADMAP_R18_FINAL_LINES = (
    "| V2-R18 | Local Directional Trend Strength Foundation | "
    "COMPLETED / REGISTERED_LOCAL_DIRECTIONAL_STRENGTH_CALCULATION_ONLY |",
    "Next product implementation phase: NOT_SELECTED / NOT_APPROVED.",
    "No successor phase starts automatically.",
)
GAP_ROADMAP_R19_APPROVAL_LINES = (
    "| V2-R19 | Local Percentage Price Oscillator Foundation | "
    "APPROVED / NOT_STARTED / REGISTERED_LOCAL_PERCENTAGE_OSCILLATOR_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R19 / APPROVED.",
    "No successor phase after V2-R19 starts automatically.",
)
GAP_ROADMAP_R19_DELIVERY_LINES = (
    "| V2-R19 | Local Percentage Price Oscillator Foundation | "
    "IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_PERCENTAGE_OSCILLATOR_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R19 / APPROVED.",
    "No successor phase after V2-R19 starts automatically.",
)
GAP_ROADMAP_R19_FINAL_LINES = (
    "| V2-R19 | Local Percentage Price Oscillator Foundation | "
    "COMPLETED / REGISTERED_LOCAL_PERCENTAGE_OSCILLATOR_CALCULATION_ONLY |",
    "Next product implementation phase: NOT_SELECTED / NOT_APPROVED.",
    "No successor phase starts automatically.",
)
GAP_ROADMAP_R20_APPROVAL_LINES = (
    "| V2-R20 | Local Triple Exponential Oscillator Foundation | "
    "APPROVED / NOT_STARTED / REGISTERED_LOCAL_TRIPLE_EXPONENTIAL_OSCILLATOR_CALCULATION_ONLY |",
...
GAP_ROADMAP_R20_DELIVERY_LINES = (
    "| V2-R20 | Local Triple Exponential Oscillator Foundation | "
    "IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_TRIPLE_EXPONENTIAL_OSCILLATOR_CALCULATION_ONLY |",
    "Next product implementation phase: V2-R20 / APPROVED.",
    "No successor phase after V2-R20 starts automatically.",
)
GAP_ROADMAP_R20_FINAL_LINES = (
    "| V2-R20 | Local Triple Exponential Oscillator Foundation | "
    "COMPLETED / REGISTERED_LOCAL_TRIPLE_EXPONENTIAL_OSCILLATOR_CALCULATION_ONLY |",
    "Next product implementation phase: NOT_SELECTED / NOT_APPROVED.",
    "No successor phase starts automatically.",
)
...
GAP_ROADMAP_R21_DELIVERY_LINES = (
    "| V2-R21 | Local Robust Normalization Foundation | IMPLEMENTED_PENDING_VALIDATION / REGISTERED_LOCAL_ROBUST_NORMALIZATION_ONLY |",
    "Next product implementation phase: V2-R21 / APPROVED.",
    "No successor phase after V2-R21 starts automatically.",
)
...
V2_R17_APPROVAL_STATE = {
    "current_governance_phase_id": "V2-R17-LOCAL-STOCHASTIC-OSCILLATOR-FOUNDATION-APP-1",
    "current_governance_phase_status": "PRODUCT_PHASE_APPROVED_NOT_STARTED",
    "current_product_implementation_phase": "V2-R17",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R16-LOCAL-RANGE-CHANNEL-INDICATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "V2-R17",
    "next_product_phase_approval": "APPROVED",
}
V2_R17_APPROVAL_ROADMAP = [
    {"phase_id": phase, "status": "APPROVED_NOT_STARTED" if phase == "V2-R17" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
...
V2_R17_DELIVERY_ROADMAP = [
    {"phase_id": phase, "status": "IMPLEMENTED_PENDING_VALIDATION" if phase == "V2-R17" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R17_VALIDATED_STATE = {
    **V2_R17_APPROVAL_STATE,
    "current_governance_phase_status": "PRODUCT_DELIVERY_VALIDATED_PENDING_MERGE",
}
V2_R17_VALIDATED_ROADMAP = [
    {"phase_id": phase, "status": "VALIDATED_PENDING_MERGE" if phase == "V2-R17" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R17_FINAL_STATE = {
    "current_governance_phase_id": "NONE",
    ...
    "current_product_implementation_phase": "NONE",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R17-LOCAL-STOCHASTIC-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "NOT_SELECTED",
    "next_product_phase_approval": "NOT_APPROVED",
}
V2_R17_FINAL_ROADMAP = [{"phase_id": phase, "status": "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R18_APPROVAL_STATE = {
    "current_governance_phase_id": "V2-R18-LOCAL-DIRECTIONAL-TREND-STRENGTH-FOUNDATION-APP-1",
    "current_governance_phase_status": "PRODUCT_PHASE_APPROVED_NOT_STARTED",
    "current_product_implementation_phase": "V2-R18",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R17-LOCAL-STOCHASTIC-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "V2-R18",
    "next_product_phase_approval": "APPROVED",
}
V2_R18_APPROVAL_ROADMAP = [
    {"phase_id": phase, "status": "APPROVED_NOT_STARTED" if phase == "V2-R18" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
...
V2_R18_DELIVERY_ROADMAP = [
    {"phase_id": phase, "status": "IMPLEMENTED_PENDING_VALIDATION" if phase == "V2-R18" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R18_VALIDATED_STATE = {
    **V2_R18_APPROVAL_STATE,
    "current_governance_phase_status": "PRODUCT_DELIVERY_VALIDATED_PENDING_MERGE",
}
V2_R18_VALIDATED_ROADMAP = [
    {"phase_id": phase, "status": "VALIDATED_PENDING_MERGE" if phase == "V2-R18" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R18_FINAL_STATE = {
    "current_governance_phase_id": "NONE",
    ...
    "current_product_implementation_phase": "NONE",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R18-LOCAL-DIRECTIONAL-TREND-STRENGTH-FOUNDATION-APP-1",
    "next_product_implementation_phase": "NOT_SELECTED",
    "next_product_phase_approval": "NOT_APPROVED",
}
V2_R18_FINAL_ROADMAP = [{"phase_id": phase, "status": "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R19_APPROVAL_STATE = {
    "current_governance_phase_id": "V2-R19-LOCAL-PERCENTAGE-PRICE-OSCILLATOR-FOUNDATION-APP-1",
    "current_governance_phase_status": "PRODUCT_PHASE_APPROVED_NOT_STARTED",
    "current_product_implementation_phase": "V2-R19",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R18-LOCAL-DIRECTIONAL-TREND-STRENGTH-FOUNDATION-APP-1",
    "next_product_implementation_phase": "V2-R19",
    "next_product_phase_approval": "APPROVED",
}
V2_R19_APPROVAL_ROADMAP = [
    {"phase_id": phase, "status": "APPROVED_NOT_STARTED" if phase == "V2-R19" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
...
V2_R19_DELIVERY_ROADMAP = [
    {"phase_id": phase, "status": "IMPLEMENTED_PENDING_VALIDATION" if phase == "V2-R19" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R19_VALIDATED_STATE = {
    **V2_R19_APPROVAL_STATE,
    "current_governance_phase_status": "PRODUCT_DELIVERY_VALIDATED_PENDING_MERGE",
}
V2_R19_VALIDATED_ROADMAP = [
    {"phase_id": phase, "status": "VALIDATED_PENDING_MERGE" if phase == "V2-R19" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R19_FINAL_STATE = {
    "current_governance_phase_id": "NONE",
    ...
    "current_product_implementation_phase": "NONE",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R19-LOCAL-PERCENTAGE-PRICE-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "NOT_SELECTED",
    "next_product_phase_approval": "NOT_APPROVED",
}
V2_R19_FINAL_ROADMAP = [{"phase_id": phase, "status": "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R20_APPROVAL_STATE = {
    "current_governance_phase_id": "V2-R20-LOCAL-TRIPLE-EXPONENTIAL-OSCILLATOR-FOUNDATION-APP-1",
    "current_governance_phase_status": "PRODUCT_PHASE_APPROVED_NOT_STARTED",
    "current_product_implementation_phase": "V2-R20",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R19-LOCAL-PERCENTAGE-PRICE-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "V2-R20",
    "next_product_phase_approval": "APPROVED",
}
V2_R20_APPROVAL_ROADMAP = [
    {"phase_id": phase, "status": "APPROVED_NOT_STARTED" if phase == "V2-R20" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
...
V2_R20_DELIVERY_ROADMAP = [
    {"phase_id": phase, "status": "IMPLEMENTED_PENDING_VALIDATION" if phase == "V2-R20" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R20_VALIDATED_STATE = {
    **V2_R20_APPROVAL_STATE,
    "current_governance_phase_status": "PRODUCT_DELIVERY_VALIDATED_PENDING_MERGE",
}
V2_R20_VALIDATED_ROADMAP = [
    {"phase_id": phase, "status": "VALIDATED_PENDING_MERGE" if phase == "V2-R20" else "COMPLETED"}
    for phase in ROADMAP_PHASES
]
V2_R20_FINAL_STATE = {
    "current_governance_phase_id": "NONE",
    ...
    "current_product_implementation_phase": "NONE",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R20-LOCAL-TRIPLE-EXPONENTIAL-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "NOT_SELECTED",
    "next_product_phase_approval": "NOT_APPROVED",
}
V2_R20_FINAL_ROADMAP = [{"phase_id": phase, "status": "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R21_APPROVAL_STATE = {
    "current_governance_phase_id": "V2-R21-LOCAL-ROBUST-NORMALIZATION-FOUNDATION-APP-1",
    "current_governance_phase_status": "PRODUCT_PHASE_APPROVED_NOT_STARTED",
    "current_product_implementation_phase": "V2-R21",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R20-LOCAL-TRIPLE-EXPONENTIAL-OSCILLATOR-FOUNDATION-APP-1",
    "next_product_implementation_phase": "V2-R21",
    "next_product_phase_approval": "APPROVED",
}
V2_R21_APPROVAL_ROADMAP = [{"phase_id": phase, "status": "APPROVED_NOT_STARTED" if phase == "V2-R21" else "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R21_DELIVERY_STATE = {**V2_R21_APPROVAL_STATE, "current_governance_phase_status": "PRODUCT_DELIVERY_IMPLEMENTED_PENDING_VALIDATION"}
V2_R21_DELIVERY_ROADMAP = [{"phase_id": phase, "status": "IMPLEMENTED_PENDING_VALIDATION" if phase == "V2-R21" else "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R21_VALIDATED_STATE = {**V2_R21_APPROVAL_STATE, "current_governance_phase_status": "PRODUCT_DELIVERY_VALIDATED_PENDING_MERGE"}
V2_R21_VALIDATED_ROADMAP = [{"phase_id": phase, "status": "VALIDATED_PENDING_MERGE" if phase == "V2-R21" else "COMPLETED"} for phase in ROADMAP_PHASES]
V2_R21_FINAL_STATE = {
    "current_governance_phase_id": "NONE",
    "current_governance_phase_status": "NONE",
    "current_product_implementation_phase": "NONE",
    "latest_completed_governance_delivery": "FCF-V2-MARKET-SESSION-RESEARCH-ARCHITECTURE-SYNC-APP-1",
    "latest_completed_product_phase": "V2-R21-LOCAL-ROBUST-NORMALIZATION-FOUNDATION-APP-1",
    "next_product_implementation_phase": "NOT_SELECTED",
    "next_product_phase_approval": "NOT_APPROVED",
}
...
def build_project_memory_guard_report(
    ...
    checks = {
        ...
        == (
            ...
            else V2_R17_APPROVAL_ROADMAP
            if current_truth == V2_R17_APPROVAL_STATE
            else V2_R17_DELIVERY_ROADMAP
            if current_truth == V2_R17_DELIVERY_STATE
            else V2_R17_VALIDATED_ROADMAP
            if current_truth == V2_R17_VALIDATED_STATE
            else V2_R17_FINAL_ROADMAP
            if current_truth == V2_R17_FINAL_STATE
            else V2_R18_APPROVAL_ROADMAP
            if current_truth == V2_R18_APPROVAL_STATE
            else V2_R18_DELIVERY_ROADMAP
            if current_truth == V2_R18_DELIVERY_STATE
            else V2_R18_VALIDATED_ROADMAP
            if current_truth == V2_R18_VALIDATED_STATE
            else V2_R18_FINAL_ROADMAP
            if current_truth == V2_R18_FINAL_STATE
            else V2_R19_APPROVAL_ROADMAP
            if current_truth == V2_R19_APPROVAL_STATE
            else V2_R19_DELIVERY_ROADMAP
            if current_truth == V2_R19_DELIVERY_STATE
            else V2_R19_VALIDATED_ROADMAP
            if current_truth == V2_R19_VALIDATED_STATE
            else V2_R19_FINAL_ROADMAP
            if current_truth == V2_R19_FINAL_STATE
            else V2_R20_APPROVAL_ROADMAP
            if current_truth == V2_R20_APPROVAL_STATE
            else V2_R20_DELIVERY_ROADMAP
            if current_truth == V2_R20_DELIVERY_STATE
            else V2_R20_VALIDATED_ROADMAP
            if current_truth == V2_R20_VALIDATED_STATE
            else V2_R20_FINAL_ROADMAP
            if current_truth == V2_R20_FINAL_STATE
            else V2_R21_APPROVAL_ROADMAP
            if current_truth == V2_R21_APPROVAL_STATE
            else V2_R21_DELIVERY_ROADMAP
            if current_truth == V2_R21_DELIVERY_STATE
            else V2_R21_VALIDATED_ROADMAP
        ...
        or (
            current_truth == V2_R17_APPROVAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R17_APPROVAL_LINES)
        )
        or (
            current_truth in (V2_R17_DELIVERY_STATE, V2_R17_VALIDATED_STATE)
            and all(line in gap for line in GAP_ROADMAP_R17_DELIVERY_LINES)
        )
        or (
            current_truth == V2_R17_FINAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R17_FINAL_LINES)
        )
        or (
            current_truth == V2_R18_APPROVAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R18_APPROVAL_LINES)
        )
        or (
            current_truth in (V2_R18_DELIVERY_STATE, V2_R18_VALIDATED_STATE)
            and all(line in gap for line in GAP_ROADMAP_R18_DELIVERY_LINES)
        )
        or (
            current_truth == V2_R18_FINAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R18_FINAL_LINES)
        )
        or (
            current_truth == V2_R19_APPROVAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R19_APPROVAL_LINES)
        )
        or (
            current_truth in (V2_R19_DELIVERY_STATE, V2_R19_VALIDATED_STATE)
            and all(line in gap for line in GAP_ROADMAP_R19_DELIVERY_LINES)
        )
        or (
            current_truth == V2_R19_FINAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R19_FINAL_LINES)
        )
        or (
            current_truth == V2_R20_APPROVAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R20_APPROVAL_LINES)
        )
        or (
            current_truth in (V2_R20_DELIVERY_STATE, V2_R20_VALIDATED_STATE)
            and all(line in gap for line in GAP_ROADMAP_R20_DELIVERY_LINES)
        )
        or (
            current_truth == V2_R20_FINAL_STATE
            and all(line in gap for line in GAP_ROADMAP_R20_FINAL_LINES)
        )
        ...
        "v2_r17_approval_exact_across_authorities": current_truth
        not in (
            V2_R17_APPROVAL_STATE,
            V2_R17_DELIVERY_STATE,
            V2_R17_VALIDATED_STATE,
        ...
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
                authority_texts, V2_R17_APPROVAL_START, V2_R17_APPROVAL_END
            )
        ),
        "v2_r17_lock_exact_across_authorities": current_truth
        not in (V2_R17_DELIVERY_STATE, V2_R17_VALIDATED_STATE, V2_R17_FINAL_STATE)
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(authority_texts, V2_R17_LOCK_START, V2_R17_LOCK_END)
        ),
        "v2_r17_final_exact_across_authorities": current_truth
        != V2_R17_FINAL_STATE
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
        ...
        "v2_r18_approval_exact_across_authorities": current_truth
        not in (
            V2_R18_APPROVAL_STATE,
            V2_R18_DELIVERY_STATE,
            V2_R18_VALIDATED_STATE,
        ...
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
                authority_texts, V2_R18_APPROVAL_START, V2_R18_APPROVAL_END
            )
        ),
        "v2_r18_lock_exact_across_authorities": current_truth
        not in (V2_R18_DELIVERY_STATE, V2_R18_VALIDATED_STATE, V2_R18_FINAL_STATE)
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(authority_texts, V2_R18_LOCK_START, V2_R18_LOCK_END)
        ),
        "v2_r18_final_exact_across_authorities": current_truth
        != V2_R18_FINAL_STATE
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
        ...
        "v2_r19_approval_exact_across_authorities": current_truth
        not in (
            V2_R19_APPROVAL_STATE,
            V2_R19_DELIVERY_STATE,
            V2_R19_VALIDATED_STATE,
        ...
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
                authority_texts, V2_R19_APPROVAL_START, V2_R19_APPROVAL_END
            )
        ),
        "v2_r19_lock_exact_across_authorities": current_truth
        not in (V2_R19_DELIVERY_STATE, V2_R19_VALIDATED_STATE, V2_R19_FINAL_STATE)
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(authority_texts, V2_R19_LOCK_START, V2_R19_LOCK_END)
        ),
        "v2_r19_final_exact_across_authorities": current_truth
        != V2_R19_FINAL_STATE
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
        ...
        "v2_r20_approval_exact_across_authorities": current_truth
        not in (
            V2_R20_APPROVAL_STATE,
            V2_R20_DELIVERY_STATE,
            V2_R20_VALIDATED_STATE,
        ...
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
                authority_texts, V2_R20_APPROVAL_START, V2_R20_APPROVAL_END
            )
        ),
        "v2_r20_lock_exact_across_authorities": current_truth
        not in (V2_R20_DELIVERY_STATE, V2_R20_VALIDATED_STATE, V2_R20_FINAL_STATE)
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(authority_texts, V2_R20_LOCK_START, V2_R20_LOCK_END)
        ),
        "v2_r20_final_exact_across_authorities": current_truth
        != V2_R20_FINAL_STATE
        or (
            len(authority_texts) == len(AUTHORITY_PATHS)
            and blocks_are_exact(
