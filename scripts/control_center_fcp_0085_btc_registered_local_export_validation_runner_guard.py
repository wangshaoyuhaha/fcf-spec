...
from apps.fcp_0085_btc_registered_local_export_validation_runner_app_1 import (  # noqa: E402
...
DELIVERY_ID = "FCF-FCP-0085-BTC-REGISTERED-LOCAL-EXPORT-VALIDATION-RUNNER-APP-1"
MARKER = "FCP 0085 BTC REGISTERED LOCAL EXPORT VALIDATION RUNNER APP 1"
CONTRACT_PATH = "apps/fcp_0085_btc_registered_local_export_validation_runner_app_1/contracts.py"
RUNNER_PATH = "apps/fcp_0085_btc_registered_local_export_validation_runner_app_1/runner.py"
CONTRACT_SHA = "d57af3289110b15e002e90b1415d6dffb79a01e8198d78b71ff8776d2fe67ef6"
RUNNER_SHA = "e98171e92d8dec0175620644a8d1af53ac3353ad0c2db5be0a07eb8bbbfc6ca1"
REFERENCE_RESULT_HASH = "a7900ce1e79cbe7891774b3cb835939ee08e3c4242df0704390b309ced07a3f8"
REFERENCE_OUTPUT_SHA = "981a2deb6c028bebd9f5ead948dc55737e8d49c37aa954bfd12ea1df1ac8590b"
...
def build_fcp_0085_guard_report(root: Path = ROOT) -> dict[str, object]:
    try:
        ...
        reference_output = render_validation_json(reference).encode("ascii")
        readable = True
    ...
    proposal = next(
        (
            ...
            if item.get("proposal_id") == "FCF-FCP-0085"
        ),
        {},
    )
    expected = {
        "FCF_CURRENT_STATE_FCP_0085_BTC_REGISTERED_LOCAL_EXPORT_VALIDATION_RUNNER_APP_1_APPROVED.md",
        "FCF_CURRENT_STATE_FCP_0085_BTC_REGISTERED_LOCAL_EXPORT_VALIDATION_RUNNER_APP_1_DELIVERED.md",
        "FCF_CURRENT_STATE_FCP_0085_BTC_REGISTERED_LOCAL_EXPORT_VALIDATION_RUNNER_APP_1_FINAL.md",
        "docs/FCF_FCP_0085_BTC_REGISTERED_LOCAL_EXPORT_VALIDATION_RUNNER_APP_1_D1_D6.md",
    }
    gap_row = next(
        (line for line in gaps.splitlines() if "| V2-FR-GAP-095 |" in line), ""
    )
    prohibited = (
        "import requests",
        "import socket",
    ...
    checks = {
        ...
        "architecture_registered": all(
            ...
            for term in (
                ...
                "FCP-0022 remains the sole authority",
                "path-free aggregate manifest",
            )
        ),
        "adr_registered": all(
            term in adr
            for term in (
                "FCF-V2-ADR-085",
                "Provide A Read-Only BTC Local Export Validator",
                "All byte verification",
                "FCP-0022 authority",
            )
        ),
        "gap_preserved": "| RESEARCH_REQUIRED |" in gap_row,
        "gap_observation_registered": "FCP-0085 is approved" in gaps
        and "GAP-095" in gaps,
        "protocol_registered": "Proposal `FCF-FCP-0085`" in protocol
        and "FCP-0022" in protocol,
        "memory_registered": "FCP-0085 preserves BTC local-export" in memory,
        "run_all_wired": (
            "control_center_fcp_0085_btc_registered_local_export_validation_runner_guard.py"
            in run_all
        ),
        ...
        "reference_result_hash_exact": reference is not None
        and reference.result_hash == REFERENCE_RESULT_HASH,
        ...
        and reference.network_used is False
        and reference.sdk_used is False
        and reference.gap_closed is False,
        "runner_reuses_frozen_authority": (
            "canonicalize_registered_btc_local_export" in runner_text
            and "fcp_0022_btc_local_export" in runner_text
            and "read_bytes" not in runner_text
